              ...
              <form onSubmit={handleCreateAd} className="mt-8 flex flex-col gap-4">
                <div className="flex flex-col gap-2">
                  ...
                  <Select.Root name='game'>
                    <Select.Trigger className="bg-zinc-900 py-3 px-4 rounded text-sm text-white inline-flex" aria-label="Games">
                        <Select.Value placeholder="Selecione o game que deseja jogar" />
                    </Select.Trigger>
                    <Select.Portal className="text-white">
                        <Select.Content className="overflow-hidden bg-zinc-900 py-3 px-4 rounded text-sm text-white">
                            <Select.Viewport>
                                <Select.Group>
                                    <Select.Label className="text-zinc-500">Selecione o game que deseja jogar</Select.Label>
                                    {games.map(game => {
                                        return (
                                            <Select.SelectItem key={game.id} value={game.id} className="cursor-pointer">
                ...
                <div className="flex gap-4">
                  <div className="flex flex-col gap-2">
                    ...
                    <ToggleGroup.Root type="multiple" value={weekDays} onValueChange={setWeekDays} className="grid grid-cols-4 gap-1">
